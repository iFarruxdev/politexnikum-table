...
const Schedule = () => {
  ...
  const getSubjectColor = (subject) => {
    const colorMap = {
      ...
      "O'zbek milliy taomlari": 'bg-green-50 border-green-200 hover:bg-green-100',
      "Jismoniy tarbiya / Informatika": 'bg-green-50 border-green-200 hover:bg-green-100',
      "Chilangarlik Ishi O'A / Avtomabil tuzulishi O'A": 'bg-green-50 border-green-200 hover:bg-green-100',
      "Tarbiya / Biznes asoslari O'A": 'bg-green-50 border-green-200 hover:bg-green-100',
      'Tikuv maxsulot konsturuksiyalash / Tikuvchilik buyumlari tayyorlash': 'bg-orange-50 border-orange-200 hover:bg-orange-100',
      'Informatika / Jismoniy tarbiya': 'bg-orange-50 border-orange-200 hover:bg-orange-100',
      'Avtomabil tuzulishi': 'bg-orange-50 border-orange-200 hover:bg-orange-100',
      'Avto elektr va elektr jixozlari': 'bg-orange-50 border-orange-200 hover:bg-orange-100',
      'Fizika / Rus tili': 'bg-sky-50 border-sky-200 hover:bg-sky-100',
      "Biznes asoslari O'A / CHQBT": 'bg-sky-50 border-sky-200 hover:bg-sky-100',
      "Kasb etikasi va prinsipi": 'bg-sky-50 border-sky-200 hover:bg-sky-100',
      "CHQBT / Biznes asoslari O'A": 'bg-sky-50 border-sky-200 hover:bg-sky-100',
      'Loyhalash': 'bg-lime-50 border-lime-200 hover:bg-lime-100',
      'Umumiy ovqatlanish korxonalari': 'bg-lime-50 border-lime-200 hover:bg-lime-100',
      'Nazorat kassa apparatlari': 'bg-lime-50 border-lime-200 hover:bg-lime-100',
      'Chakana savdoni tashkil etish': 'bg-lime-50 border-lime-200 hover:bg-lime-100',
      ...
      "Taom tayyorlash texnalogiyasi": 'bg-yellow-50 border-yellow-200 hover:bg-yellow-100',
      ...
      "Rus tili / Oshpazlik taomlarini tayyorlash O'A": 'bg-violet-50 border-violet-200 hover:bg-violet-100',
      'Umumiy ovqatlanish Texnalogiyasi': 'bg-violet-50 border-violet-200 hover:bg-violet-100',
      ...
      "Tarbiya / Oshpazlik taomlarini tayyorlash O'A": 'bg-orange-50 border-orange-200 hover:bg-orange-100',
